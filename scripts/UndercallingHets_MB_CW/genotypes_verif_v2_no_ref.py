...
list_of_indiv=open('../CorrectedGenos_Individs.txt','r')
for indiv in list_of_indiv:						## For each string in the file
	...
	matches_file=open('../../stacksv44/stacks_v44/'+ indiv_name +'.matches.tsv','r')	# Open the matches.tags file for each individual in indiv_name list
...
#	print ind_loc_vs_cat
	...
	Indiv_file=open('../../stacksv44/stacks_v44/'+ indiv_name +'.tags.tsv','r')	
