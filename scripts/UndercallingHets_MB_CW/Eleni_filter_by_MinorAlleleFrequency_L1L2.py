...
output_freqs = open("../../L1L2stacks_m10/batch_1_filteredMAF_outputFreqs",'w')
filtered_genotypes = open("../../L1L2stacks_m10/batch_1_filteredMAF_genotypes.csv",'w')
blacklisted_genotypes = open("../../L1L2stacks_m10/batch_1_filteredMAF_BADgenotypes.csv" ,'w')
blacklisted_MAF = open("../../L1L2stacks_m10/batch1_blacklistedMAF.csv",'w')
