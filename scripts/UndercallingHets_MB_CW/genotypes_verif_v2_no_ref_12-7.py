...
genotype_file=open('/mnt/hgfs/Pacific cod/DataAnalysis/L1L2stacks_m10/batch_1.CorrectedGenos_2alleles.txt' ,'w')
...
Catalog_file=open('/mnt/hgfs/Pacific cod/DataAnalysis/L1L2stacks_m10/batch_1.biallelic_catalog.tsv','r')
...
for indiv in list_of_indiv:						## For each string in the file
	...
	matches_file=open('/mnt/hgfs/Pacific cod/DataAnalysis/L1L2stacks_m10/'+ indiv_name +'.matches.tsv','r')	# Open the matches.tags file for each individual in indiv_name list
...
#	print ind_loc_vs_cat
	...
	Indiv_file=open('/mnt/hgfs/Pacific cod/DataAnalysis/L1L2stacks_m10/'+ indiv_name +'.tags.tsv','r')	
